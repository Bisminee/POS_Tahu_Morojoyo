    ...
    <div class="min-h-screen bg-[#FFF8E7] flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-3xl shadow-xl border-t-4 border-[#C0271A] overflow-hidden">
                ...
                {{-- Card header --}}
                <div class="bg-[#C0271A] px-8 py-6">
                    <div class="flex place-items-center align-center gap-3">
                        <div>
                            <h1 class="text-white font-black text-2xl leading-tight" style="font-family:'Bebas Neue',sans-serif">LOGIN KASIR</h1>
                            <p class="text-red-200 text-xs mt-0.5">Masuk ke sistem POS Morojoyo</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-8 py-7">
                    ...
                    <form action="{{ route('cashier.login.submit') }}" method="POST" class="space-y-5">
                        ...
                        <button
                            type="submit"
                            class="w-full bg-[#C0271A] hover:bg-[#9B1E13] active:scale-[.98] text-white font-black text-xl py-3.5 rounded-2xl transition-all shadow-lg shadow-red-200 flex items-center justify-center gap-2 mt-2"
