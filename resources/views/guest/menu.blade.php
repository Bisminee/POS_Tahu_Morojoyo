  ...
  <nav class="sticky top-0 z-50 bg-white border-b-4 border-brand-red shadow-md">
    <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
      ...
      <ul class="hidden md:flex items-center gap-8">
        ...
        <li><a href="{{ route('menu') }}" class="nav-link active font-body text-gray-800 font-bold text-sm tracking-wide hover:text-brand-red transition-colors">Menu</a></li>
    ...
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="flex flex-wrap justify-center gap-8">
        <div class="bg-white rounded-3xl overflow-hidden shadow-md card-hover w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.4rem)]">
          ...
          <div class="h-70 bg-brand-red flex items-center justify-center relative p-12">
            <span class="text-8xl float-1 w-full h-42"><img src="{{ asset('img/ori.png') }}"></span>
            <span class="absolute top-3 right-3 bg-brand-yellow text-brand-darkred font-display text-xs px-3 py-1 rounded-full">Best Seller</span>
          </div>
          <div class="p-5">
            <h3 class="font-display text-brand-red text-2xl">TAHU BAKSO ORIGINAL</h3>
            <p class="text-gray-500 text-sm mt-1 font-body">Sensasi pedas menggigit dengan sambal cabai rawit pilihan.</p>
            <div class="mt-4 text-right">
              <span class="font-display text-brand-red text-3xl" >Rp 3.000</span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-3xl overflow-hidden shadow-md card-hover w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.4rem)]">
          <div class="h-70 bg-brand-red flex items-center justify-center relative p-12">
            <span class="text-8xl float-1 w-full h-42 "><img src="{{ asset('img/pedas.png') }}"></span>
            <span class="absolute top-3 right-3 bg-red-600 text-white font-display text-xs px-3 py-1 rounded-full">Pedas!</span>
          </div>
          <div class="p-5">
            <h3 class="font-display text-brand-red text-2xl">TAHU BAKSO PEDAS</h3>
            <p class="text-gray-500 text-sm mt-1 font-body">Sensasi pedas menggigit dengan sambal cabai rawit pilihan.</p>
            <div class="mt-4 text-right">
              <span class="font-display text-brand-red text-3xl" >Rp 3.000</span>
            </div>
        ...
        <div class="bg-white rounded-3xl overflow-hidden shadow-md card-hover w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.4rem)]">
          <div class="h-70 bg-brand-red flex items-center justify-center relative p-12">
            <span class="text-8xl float-1 w-full h-37 "><img src="{{ asset('img/keju.png') }}"></span>
          </div>
          <div class="p-5">
            <h3 class="font-display text-brand-red text-2xl">TAHU BAKSO KEJU</h3>
            <p class="text-gray-500 text-sm mt-1 font-body">Semangkuk bakso kenyal dengan kuah rempah hangat dan mie.</p>
            <div class="mt-4 text-right">
              <span class="font-display text-brand-red text-3xl" >Rp 15.000</span>
            </div>
          </div>
        </div>

        <div class="bg-white rounded-3xl overflow-hidden shadow-md card-hover w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.4rem)]">
          <div class="h-70 bg-brand-red flex items-center justify-center p-12">
            <span class="text-8xl float-1 w-full h-42 "><img src="{{ asset('img/mix.png') }}"></span>
          </div>
          <div class="p-5">
            <h3 class="font-display text-brand-red text-2xl">TAHU BAKSO MIX</h3>
            <p class="text-gray-500 text-sm mt-1 font-body">Tahu crispy dengan isian sayur dan daging cincang gurih.</p>
            <div class="mt-4 text-right">
              <span class="font-display text-brand-red text-3xl" >Rp 2.500</span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-3xl overflow-hidden shadow-md card-hover w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.4rem)]">
          <div class="h-70 bg-brand-red flex items-center justify-center relative p-12">
            <span class="text-8xl float-1 w-full h-42 "><img src="{{ asset('img/s_cheese.png') }}"></span>
            <span class="absolute top-3 right-3 bg-red-600 text-white font-display text-xs px-3 py-1 rounded-full">Pedas!</span>
          </div>
          <div class="p-5">
            <h3 class="font-display text-brand-red text-2xl">TAHU BAKSO SPICY CHEESE</h3>
            <p class="text-gray-500 text-sm mt-1 font-body">Sensasi pedas menggigit dengan sambal cabai rawit pilihan.</p>
            <div class="mt-4 text-right">
              <span class="font-display text-brand-red text-3xl" >Rp 3.000</span>
            </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 pb-10">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="https://wa.me/62812" class="font-body text-gray-500 text-sm hover:text-brand-red transition flex items-center gap-2"><span><img src="{{ asset('img/tel.png') }}" class="w-full h-5"></span> +62 812-XXXX-XXXX</a></li>
